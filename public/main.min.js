                    ...
                    value: function() {
                        var e = this,
                            t = new Promise(function(t, n) {
                                var o = e.options.debug ? "//imasdk.googleapis.com/js/sdkloader/ima3_debug.js" : "",
        ...
        var a = o(e("../package.json")),
            ...
            p = function() {
                function e(t) {
                    ...
                    (new Image).src = "", this.eventBus = new c.default, this.eventBus.gameId = this.options.gameId + "", this.eventBus.subscribe("SDK_BLOCKED", function(e) {
                        return n._onEvent(e)
                    ...
                    var y = new Promise(function(e) {
                        ...
                        /* fetch(i).then(function(e) {
                            ...
                            if (n.error)(0, u.dankLog)("SDK_GAME_DATA_READY", n.error, "warning");
                                ...
                                ["y8.com", "pog.com", "dollmania.com"].indexOf(p) > -1 ? t.midroll = 3e5 : i.indexOf(p) > -1 && (t.midroll = 6e4), ["happygames.io", "happygames-dev.gamedistribution.com"].indexOf(p) > -1 && (t.preroll = !1), (0, u.dankLog)("SDK_GAME_DATA_READY", t, "success")
                            }
                            e(t)
                        }).catch(function(n) {
                ...
                return s(e, [{
                    ...
                    value: function(e, t) {
                        var n = this;
                        (0, h.getScript)("", "gdsdk_google_analytics").then(function() {
                        ...
                        }), e || (0, h.getScript)("", "LOTCC_13998").then(function() {
